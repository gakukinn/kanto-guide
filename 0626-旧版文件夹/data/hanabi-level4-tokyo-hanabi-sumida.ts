/**
 * 第四层数据文件 - 隅田川花火大会详解数据
 * @layer 四层 (Detail Data)
 * @region 东京
 * @category 花火
 * @event 隅田川花火大会
 * @type 花火详解数据文件
 * @contains 完整的花火大会信息：基本信息、会场、交通、观赏攻略、历史背景等
 * @usage 供 /tokyo/hanabi/sumida 页面使用
 * @architecture 二度计划四层架构：首页 → 地区 → 活动 → 详解
 */
