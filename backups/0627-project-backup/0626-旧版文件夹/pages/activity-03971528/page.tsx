...
/**
 * 花火会详情页面
 * 数据库ID: recognition-hanabi-1750908587828
 * 生成时间: 2025/6/26 12:29:47
...
const DetailPage = () => {
  // 转换后的活动数据
  const activityData = {
  id: "recognition-hanabi-1750908587828",
  ...
  media: [
    {
      type: "image" as const,
      url: "https://img2.mypl.net/image.php?id=4124e883670c757d607c98455a509201d2a0d818_cms_image.jpeg&p=s3-img-origin02&s=960_1480&op=",
