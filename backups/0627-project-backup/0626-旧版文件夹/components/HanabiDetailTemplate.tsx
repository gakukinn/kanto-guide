        ...
        <section className="bg-gradient-to-r from-red-50 to-blue-100 py-12">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-8 transform rounded-3xl border-2 border-red-200 bg-gradient-to-r from-red-50 to-blue-100 p-6 shadow-xl backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl md:p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="rounded-lg border border-gray-200 bg-gray-100 px-6 py-2 font-medium text-gray-500 shadow-sm opacity-50 cursor-not-allowed">
                    发表评论 (静态页面)
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              {/* 加载更多 */}
              <div className="text-center">
                <div className="rounded-full border border-red-200/50 bg-gray-100 px-6 py-2 font-medium text-gray-500 shadow-md opacity-50 cursor-not-allowed">
                  📄 加载更多评论 (静态页面)
                </div>
              </div>
            </div>
