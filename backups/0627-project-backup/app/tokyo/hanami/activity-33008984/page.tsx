 ...
 * 3. 开催期间: 2025年4月29日～6月30日　 開園時間/9:00～17:00（最終入園は16:30）　※春バラの開花時期は気象条件により変動する場合あり
 * 4. 开催场所: 東京都　旧古河庭園
 * 5. 交通方式: ＪＲ京浜東北線「上中里駅」もしくは地下鉄南北線「西ヶ原駅」から徒歩7分、またはＪＲ山手線「駒込駅」から徒歩12分
 * 6. 主办方: 未设置
...
const DetailPage = () => {
  ...
  datetime: "2025年4月29日～6月30日　 開園時間/9:00～17:00（最終入園は16:30）　※春バラの開花時期は気象条件により変動する場合あり",
  venue: "東京都　旧古河庭園",
  access: "ＪＲ京浜東北線「上中里駅」もしくは地下鉄南北線「西ヶ原駅」から徒歩7分、またはＪＲ山手線「駒込駅」から徒歩12分",
  organizer: "",
  ...
  region: "tokyo",
  description: "薔薇の名所として知られる旧古河庭園では、例年4月下旬から6月下旬にかけて春バラが見頃を迎えます。約100種200株の華やかなバラが咲き誇る洋風庭園と重厚な洋館、風情ある日本庭園が楽しめます。見頃に合わせて「春のバラフェスティバル」が開催され、早朝開園のほか、音楽会、春バラの人気投票、庭園ガイドなどが行われ、色とりどりの美しいバラと芳香に包まれながら、優雅なひと時を過ごすことができます。芝生広場アプローチ部分ではローズガーデンマーケットが開かれ、バラグッズや花鉢などが販売されます。",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
