...
export const metadata = {
  ...
  description: '【※大会项目为过往信息。预定举办的大会详细信息确定后将公布、信息更新】関東有数の規模を誇る、埼玉県さいたま市の「さいたま市花火大会」は3会場に分けて举办花火大会。オープニングを飾る大和田公園会場は見通しの良さが自慢。早打ち、连发烟花など多種多様な花火が打燃放がり、さいたまの夏の夜空に大輪の花火が描かれる。',
};
