...
const activityData = {
  ...
  "region": "koshinetsu",
  "description": "为信州上田的夏天上色的大型烟花节将在千曲川河岸举行。2025年迎来第38回，以创作烟火、大型连续花火、音乐 连续花火为中心，5号球等约8000发烟火将被施放。在景色优美的河岸上，你可以欣赏到在你眼前燃烧的壮观烟花。※发射数：去年8000发观众数：去年80，000人",
  "activityType": "hanabi",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
  ...
  "parking": "详见官网",
  "foodStalls": "详见官网",
  "notes": "为信州上田的夏天增色的大型烟花节将在千曲川河岸举行。2025年迎来第38回，以创作烟火、大型连续花火、音乐 连续花火为中心，5号球等约8000发烟火将被施放。在风景优美的河岸上，你可以欣赏到在你眼前燃放的壮观烟花。※发射数：去年8000发观众数：去年80，000人",
  "date": "详见官网",
  "time": "详见官网"
};
...
export async function generateMetadata() {
  return {
    ...
    description: '信州上田の夏装点大花火大会が、千曲川河川敷で開催举行。2025年で第38回を迎え、創作花火、ワイド连发烟花、ミュージック连发烟花を中心に、5号玉など約8000発の花火が打燃放げられます。...',
  };
}
