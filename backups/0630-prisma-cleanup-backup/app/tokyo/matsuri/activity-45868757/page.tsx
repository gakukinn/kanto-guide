...
const DetailPage = () => {
  ...
  region: "tokyo",
  description: "“羽田节”是一个非常热闹的节日，光是神龛的携带者就有3000人，参观者就有30，000人。神輿是一种英勇的搬运方法，通常被称为“横田”，模仿在海浪中摆动的船只，是羽田的独特之处，羽田曾是一个繁荣的渔民城镇。星期日下午的町内神轿联合渡御（神轿游行），14町会14座神轿在约可塔游行。从相当于氏子的羽田机场，迎接全日空和日本航空的乘务员们，为游行增添了鲜花。2025年是为了纪念“昭和百年”，相隔6年的凤鹰巡行（出发7：30）也将一同举行。",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
