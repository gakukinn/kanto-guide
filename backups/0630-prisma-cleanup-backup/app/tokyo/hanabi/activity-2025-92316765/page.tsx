...
const pageData = {
  ...
  "region": "tokyo",
  "activityType": "hanabi",
  "description": "在东京都明治神宫外苑（神宫球场、秩父宫橄榄球场）举行的烟花大会。在欣赏艺术家的现场音乐会后，可以从自己的座位上慢慢欣赏烟花的城市型烟花大会而闻名。这是东京唯一一个在山手线内举行的烟花大会，多年来一直受到许多人的喜爱。表演艺术家和门票的信息将在官方网站上公布。",
  "highlights": "大约10，000发烟花与音乐一起在夜空中发射，从近距离可以感受到震撼力。吸引人的是，你可以欣赏豪华嘉宾的现场表演和烟花。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
...
export const metadata = {
  ...
  description: '東京都の明治神宮外苑(神宮球場、秩父宮ラグビー場)で举办花火大会。アーティストによるライブコンサートを楽しんだ後に、自分の席からゆっくりと花火を鑑賞可以都市型の花火大会として知られている。都内で唯一、山手線内で举办この花火大会は、長年にわたり多くの人々に親しまれている。出演アーティストやチケット的信息は公式サイトで発表される予定。',
};
