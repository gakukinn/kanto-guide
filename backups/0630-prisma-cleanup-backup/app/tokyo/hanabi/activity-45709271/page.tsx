 ...
 * 5. 交通方式: 地下鉄都営新宿線「篠崎駅」步行15分、或ＪＲ総武線「小岩駅」步行25分或者京成巴士「南小岩二丁目」～徒歩10分
 * 6. 主办方: 江戸川区、江戸川区花火大会実行委員会
 * 7. 料金: 有料観覧席有　※詳細は江戸川区花火大会官网を参照
...
const DetailPage = () => {
  ...
  access: "地下鉄都営新宿線「篠崎駅」步行15分、或ＪＲ総武線「小岩駅」步行25分或者京成巴士「南小岩二丁目」～徒歩10分",
  organizer: "江戸川区、江戸川区花火大会実行委員会",
  price: "有料観覧席有　※詳細は江戸川区花火大会官网を参照",
  ...
  region: "tokyo",
  description: "“江户川烟花节”将在江户川河边举行，为江户川的夏天增色。2025年，以不同的7个主题为基础，根据各自的形象，搭乘背景音乐，8号玉和音乐烟火等约1万4000发，将为夜空上色。作为大会50周年纪念的主要项目，江户川著名的“富士大装置”将以“最高的山型烟花”挑战吉尼斯世界纪录。将举行烟花设计的公开招募，并在宗家烟花锁匠的审查下，燃放自由和独创性的烟花。※发射数：1万4000发，去年发射数：1万4000发，观众数：3万人，去年3万人（※均为赞助席、收费席的来场人数）",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
