...
const pageData = {
  ...
  "date": "2025年8月16日(土)",
  "time": "烟火表演时间：19：30 - 20：30",
  "venue": "明治神宮外苑",
  "access": "[火车]从JR千谷站或信野町站步行5 - 10分钟，从Gaienmae站或Aoyama 1-chome站或Omotesando站步行5 - 10分钟，从Toei地铁国家体育场站步行5 - 10分钟",
  "weatherInfo": "小雨决定了。如遇荒天，则延期至2025年8月17日（星期日）※荒天中止决定将于举办日中午在官方网站、各社交媒体发布。",
  "parking": "×",
  ...
  "region": "tokyo",
  "activityType": "hanabi",
  "description": "江户川区烟花大会将于2025年迎来50届。以厚层结构的烟火、与BGM同步的演出为特征，创业超过360年的宗家烟火“钥屋”负责。开幕式5秒钟内发射1000发子弹，日本最大的富士电视台的大型装置，以及激动人心的金卡米罗的高潮是壮观的。从6月中旬左右开始还将进行收费座位的一般销售（详细内容请参照官方网站）。",
  "highlights": "以7个不同的主题为基础，一边播放符合各自形象的BGM，一边用美丽的烟花给夜空上色。作为大会50周年的主要项目，江户川名产“富士大装置”以“最高的山型烟花”挑战吉尼斯世界纪录（R）。另外，公开征集烟花的设计。在Soke烟花锁匠的审查下，自由和独创性的烟花将被点燃。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
...
export const metadata = {
  ...
  description: '2025年で50回の節目を迎える江戸川区花火大会。厚みのある多層構造の花火、背景音乐とシンクロした演出が特徴で、創業360年を超える宗家花火「鍵屋」が担当する。オープニングの5秒で1000発の迫力ある打燃放げ、国内最大級の富士の大仕掛け、クライマックスを飾る怒涛の金カムロは圧巻だ。6月中旬ごろから有料席の一般販売も举行(詳細は公式サイト参照)。',
};
