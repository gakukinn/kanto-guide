...
const activityData = {
  ...
  "parking": "详见官网",
  "foodStalls": "详见官网",
  "notes": "さいたま市花火大会のオープニングを飾る花火大会が、大和田公園で開催されます。早打ち、スターマインなどが打ち上げられ、夏の夜空を華やかに彩ります。大和田公園会場は、見通しの良さが特徴でどの方角からも美しい花火が楽しめます。さいたま市花火大会は、浦和地区（大間木公園）と岩槻地区（岩槻文化公園）でも催されます。 ※打ち上げ数：昨年度4000発 観客数：昨年度9万人",
  "date": "详见官网",
  "time": "详见官网"
};
