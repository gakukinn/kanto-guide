...
const activityData = {
  ...
  "createdAt": "2025-06-26T13:49:48.110Z",
  "updatedAt": "2025-06-26T13:49:48.110Z",
  "detailLink": "/tokyo/hanabi/activity-event-66-45788095",
  "fireworksCount": "详见官网",
  "fireworksTime": "详见官网",
  ...
  "parking": "详见官网",
  "foodStalls": "详见官网",
  "notes": "荒川を挟んで両岸にある東京都板橋区と埼玉県戸田市で、2つの花火大会が同時開催されます。両岸で約1万5000発が打ち上げられる、東京都内屈指の花火大会です。恒例となっている日本最高峰の花火師が手掛けた「芸術玉」をはじめ、東京最大級の大玉「尺五寸玉」、フィナーレを飾るワイドスターマイン「天空のナイアガラ」など、見どころが満載です。打ち上げ場所が観客席に近いことから、おなかに響くような轟音も醍醐味の一つです。5か所同時打ち上げのワイドスターマインが質、量ともにグレードアップされ、オープニングやフィナーレなどで迫力ある演出が行われます。 ※打ち上げ数：1万5000発、昨年度1万5000発 観客数：55万人、昨年度57万人",
  "date": "详见官网",
  "time": "详见官网"
};
...
export async function generateMetadata() {
  return {
    title: '第66回いたばし花火大会（いたばしはなびたいかい） - 东京花火大会',
    description: '荒川を挟んで両岸にある東京都板橋区と埼玉県戸田市で、2つの花火大会が同時開催されます。両岸で約1万5000発が打ち上げられる、東京都内屈指の花火大会です。恒例となっている日本最高峰の花火師が手掛けた「...',
  };
}
