...
export const metadata = {
  ...
  description: '【※大会项目为过往信息。预定举办的大会详细信息确定后将公布、信息更新】栃木県小山市の清流思川を会場に举办、関東有数の規模を誇る大会。市制70周年の今年は、おやまサマーフェスティバル2024「天に願いを 希望の花火！～make history～」をテーマに様々な花火が被燃放。会場には有料席が設けられ迫力満点の花火が堪能可以。',
};
