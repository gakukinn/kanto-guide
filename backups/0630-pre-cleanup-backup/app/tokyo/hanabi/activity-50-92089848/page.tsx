...
export const metadata = {
  ...
  description: '2025年で50回の節目を迎える江戸川区花火大会。厚みのある多層構造の花火、BGMとシンクロした演出が特徴で、創業360年を超える宗家花火「鍵屋」が担当する。オープニングの5秒で1000発の迫力ある打燃放げ、国内最大級の富士の大仕掛け、クライマックスを飾る怒涛の金カムロは圧巻だ。6月中旬ごろから有料席の一般販売も举行(詳細は官方网站参照)。',
};
