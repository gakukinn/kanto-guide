...
export const metadata = {
  ...
  description: '2025年のテーマは「J-POP BEST」で、「昭和100年」という記念の年にふさわしく、 誰もが知る名曲に合わせて花火が打ちあがる。およそ2キロのコースを有する広大な競馬場を舞台に、音楽とシンクロした大規模な花火が繰り広放のは、ここだけの特別な体験。全席指定席で混雑を気にせずゆったり鑑賞でき、トイレや飲食ブースなどの設備も整っているため、幅広い世代が快適に楽しめる。会場は最寄り駅步行すぐというアクセスの良さも魅力で、都内からも気軽に訪れることが可以。',
};
