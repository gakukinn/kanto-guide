...
const DetailPage = () => {
  ...
  region: "koshinetsu",
  description: "城下町村上特有的雄壮而华丽的祭典“村上大祭”正在举行。将神灵奉还在3座神轿上，荒马14骑，以幼仔行列为先导在町内巡回的“旅神事”成为值得一看的地方。最令人印象深刻的是Oshagiri（19辆街头花车），有着令人惊叹的雕塑和村上传统的漆漆，吸引了许多游客前来观看它。2018年1月，“村上节的摊位活动”被指定为国家重要的非物质民间文化财产。它也被称为新潟的三大高市（高町=庙会），有许多摊位，非常热闹。",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
