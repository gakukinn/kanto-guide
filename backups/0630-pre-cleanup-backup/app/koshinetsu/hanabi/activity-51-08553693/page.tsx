...
export const metadata = {
  ...
  description: '新潟県で流れる阿賀野川で举办花火大会。2025年のテーマは「『歩』Ayumu～未来への第一歩、ここから～」で、更なる存在と進化を求め、地域の活性化と未来の子どもたちとともに歩き続ける。色とりどりの连发烟花で始まり、2尺玉、大切な方へのお祝い花火、夏をテーマに小学生約1000人から選ばれたデザイン花火5作品などが被燃放。公式YouTubeチャンネルによる無料ライブ中継もある。',
};
