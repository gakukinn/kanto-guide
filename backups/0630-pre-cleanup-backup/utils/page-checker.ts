...
export class PageChecker {
  private level4Pages: Level4PageInfo[] = [
    // 七月页面
    {
      ...
      month: '七月',
      region: '东京',
      dataFile: 'level4-july-tokyo-hanabi.ts',
      expectedEvents: 6,
    },
    {
      ...
      month: '七月',
      region: '埼玉',
      dataFile: 'level4-july-saitama-hanabi.ts',
      expectedEvents: 7,
    },
    {
      ...
      month: '七月',
      region: '千叶',
      dataFile: 'level4-july-chiba-hanabi.ts',
      expectedEvents: 7,
    },
    {
      ...
      month: '七月',
      region: '神奈川',
      dataFile: 'level4-july-kanagawa-hanabi.ts',
      expectedEvents: 3,
    },
    {
      ...
      month: '七月',
      region: '北关东',
      dataFile: 'level4-july-kitakanto-hanabi.ts',
      expectedEvents: 4,
    },
    {
      ...
      month: '七月',
      region: '甲信越',
      dataFile: 'level4-july-koshinetsu-hanabi.ts',
      expectedEvents: 6,
    },
    ...
    // 八月页面
    {
      ...
      month: '八月',
      region: '东京',
      dataFile: 'level4-august-tokyo-hanabi.ts',
      expectedEvents: 6,
    },
    {
      ...
      month: '八月',
      region: '埼玉',
      dataFile: 'level4-august-saitama-hanabi.ts',
      expectedEvents: 6,
    },
    {
      path: '/august/hanabi/chiba',
      month: '八月',
      region: '千叶',
      dataFile: 'level4-august-chiba-hanabi.ts',
      expectedEvents: 6,
    },
    {
      path: '/august/hanabi/kanagawa',
      month: '八月',
      region: '神奈川',
      dataFile: 'level4-august-kanagawa-hanabi.ts',
      expectedEvents: 4,
    },
    {
      path: '/august/hanabi/kitakanto',
      month: '八月',
      region: '北关东',
      dataFile: 'level4-august-kitakanto-hanabi.ts',
      expectedEvents: 6,
    },
    {
      path: '/august/hanabi/koshinetsu',
      month: '八月',
      region: '甲信越',
      dataFile: 'level4-august-koshinetsu-hanabi.ts',
      expectedEvents: 5,
    },
  ];
