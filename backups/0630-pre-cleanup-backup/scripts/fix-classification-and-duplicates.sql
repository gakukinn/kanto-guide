...
-- 移动 "ぎおん柏崎祭典" 从 hanabi_events 到 matsuri_events
...
-- 移动 "市川三郷町ふるさと夏祭典　「神明の花火大会」（いちかわみさとちょうふるさとなつ祭典　しんめいのはなびたいかい）" 从 matsuri_events 到 hanabi_events
...
-- 移动 "水郷潮来あやめ祭典" 从 hanami_events 到 matsuri_events
...
-- 移动 "第51回水戸のあじさい祭典" 从 hanami_events 到 matsuri_events
...
-- 移动 "第37回国宝松本城太鼓祭典（こくほうまつもとじょうたいこ祭典）" 从 culture_events 到 matsuri_events
...
-- 重复组: 名称相似度80%
-- 保留: "市川三郷町ふるさと夏祭典　「神明の花火大会」" (hanabi_events)
-- 删除: "市川三郷町ふるさと夏祭典　「神明の花火大会」（いちかわみさとちょうふるさとなつ祭典　しんめいのはなびたいかい）" (matsuri_events)
DELETE FROM matsuri_events WHERE id = 'cmc8kygzs000dvlgg8h068t2w';
...
-- 重复组: 官网URL相同
-- 保留: "第37回国宝松本城太鼓祭典" (matsuri_events)
-- 删除: "第37回国宝松本城太鼓祭典（こくほうまつもとじょうたいこ祭典）" (culture_events)
DELETE FROM culture_events WHERE id = 'cmc8mapqf0005vlhs38wrywrj';
