...
// 本庄祇園祭典基本信息（来自官方Jalan网站）
const MATSURI_DATA = {
  name: '本庄祇園祭典',
  japaneseName: 'ほんじょうぎおん祭典',
  ...
  history: {
    description: '本庄祇園祭典は、埼玉県本庄市で毎年7月に開催される伝統的な祭典です。祇園祭の伝統を受け継ぎ、山車や神輿が市街地を練り歩く勇壮な祭りとして地域の人々に愛されています。'
  },
  highlights: [
    '祇園祭',
    '山車巡行',
