...
async function addHiratsukaSevenStarFestival() {
  ...
  try {
    console.log('🔍 爬取Jalan页面中的湘南ひらつか七夕祭典信息...');
    ...
    const eventData = {
      ...
      history: {
        background: '湘南ひらつか七夕祭典は、平塚市の夏の風物詩として親しまれている伝統的な七夕祭りです。',
      ...
      contact: {
        organizer: '湘南ひらつか七夕祭典実行委員会（平塚市商業観光課内）',
        phone: '0463-35-8107',
