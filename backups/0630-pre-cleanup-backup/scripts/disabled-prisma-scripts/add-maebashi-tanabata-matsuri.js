...
async function addMaebashiTanabataMatsuri() {
  ...
  try {
    console.log('🔍 爬取Jalan页面中的前橋七夕祭典信息...');
    ...
    const eventData = {
      ...
      history: {
        background: '前橋七夕祭典は、群馬県前橋市で開催される夏の代表的な祭りです。市中心部で華やかな七夕飾りが楽しめます。',
      ...
      contact: {
        organizer: '前橋七夕祭典実施委員会事務局（前橋市まちづくり公社内）',
        phone: '027-289-5565',
