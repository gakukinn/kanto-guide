...
const DetailPage = () => {
  ...
  region: "chiba",
  description: "为纪念成田山神寺的主要形象，福明寺的本地佛，奥之院大日如来的节日“成田山祇会”，周围的城镇成为一个整体，“成田祇节”作为夏季节日举行。在神寺举行的“成田山祇园会”已有300年的历史，人们在大日如来祈祷五谷丰收和所有人的丰收，大日如来供奉的小寺也将特别开放。在市内一带，豪华绚烂的御轿和10辆山车及屋台将在3天的时间里展开舞蹈与伴奏的竞赛表演。每年有超过400，000名游客前来观看。",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
