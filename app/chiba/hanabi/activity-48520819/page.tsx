 ...
 * 5. 交通方式: ＪＲ常磐線「松戸駅」或者「北松戸駅」から徒歩35分
 * 6. 主办方: 松戸花火大会実行委員会
 * 7. 料金: 有料観覧席有　シート席（エリア1・5）/1人3000円　ほか　※詳細はホームページ参照
...
const DetailPage = () => {
  ...
  access: "ＪＲ常磐線「松戸駅」或者「北松戸駅」から徒歩35分",
  organizer: "松戸花火大会実行委員会",
  price: "有料観覧席有　シート席（エリア1・5）/1人3000円　ほか　※詳細はホームページ参照",
