...
const activityData = {
  ...
  "parking": "详见官网",
  "foodStalls": "详见官网",
  "notes": "明治41年（1908年）から、小見川の夜空を彩り続けている伝統の「水郷おみがわ花火大会」が、126回目を迎え開催されます。関東でも有数の規模を誇る特大水中スターマイン、尺玉、水中花火、仕掛花火、メッセージ花火、フラワーガーデン（予定）など、利根川の川面に炸裂する約5000発（予定）の豪快な花火が楽しめます。全国の煙火店や工場の花火師が、自慢の花火、尺玉を持ち寄って美しさを競い合う「全国尺玉コンクール」も見どころです。 ※打ち上げ数：5000発、昨年度7000発 観客数：8万人、昨年度11万人",
  "date": "详见官网",
  "time": "详见官网"
};
...
export async function generateMetadata() {
  return {
    ...
    description: '明治41年（1908年）から、小見川の夜空を彩り続けている伝統の「水郷おみがわ花火大会」が、126回目を迎え開催されます。関東でも有数の規模を誇る特大水中スターマイン、尺玉、水中花火、仕掛花火、メッセ...',
  };
}
