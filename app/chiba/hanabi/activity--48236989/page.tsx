...
const activityData = {
  ...
  "datetime": "2025年7月29日　 花火燃放/19:30～20:00（予定）　※小雨決行、荒天の場合は翌日か翌々日に順延（状況により変更となる場合有）",
  "venue": "千叶县鸭川市前原·横渚海岸",
...
export async function generateMetadata() {
  return {
    ...
    description: '鴨川の夏を子どもたちが楽しく過ごせるように、鴨川を自慢可以子どもが1人でも増えるようにと願いを込め、「鴨川市民花火大会」が開催举行。尺玉などの燃放花火約3000発が鴨川の装点夜空。「日...',
  };
}
