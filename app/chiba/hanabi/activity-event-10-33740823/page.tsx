...
const activityData = {
  ...
  "region": "chiba",
  "description": "以东京湾为背景，将举行由市民手工制作的“富津市民烟花大会”。2025年将迎来第10届，将是以促进东京海湾道路建设为目标的烟花大会。除了每年都有好评的水中烟火和尺玉等约5000发外，还加上激光演出和水上2尺玉，使富津的夜空更加华丽。在富津海水浴场的沙滩上设置了观众席，可以一边面对凉爽的海风，一边慢慢地享受眼前展开的大烟花的震撼力。※从青堀站开始收费临时巴士运行数：5000发，去年2500发观众数：50，000人，去年35，000人",
  "activityType": "hanabi",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
...
export async function generateMetadata() {
  return {
    ...
    description: '東京湾をバックに、市民による手作りの「富津市民花火大会」が開催举行。10回目を迎える2025年は、東京湾口道路建設促進を目標とした花火大会。例年好評の水中花火や尺玉など約5000発が打ち...',
  };
}
