 ...
 * 3. 开催期间: 2025年8月1日　 19:15～20:45（予定）　※恶劣天气时4日延期
 * 4. 开催场所: 千葉県香取市　小見川大橋下流利根川河畔
 * 5. 交通方式: ＪＲ成田線「小見川駅」步行30分、或東関東自動車道「佐原香取IC」驾车约20分
 * 6. 主办方: 水郷小見川観光協会
 * 7. 料金: 有料観覧席有/テーブル席2万1000円、イス席3000円　※6月2日からインターネットで申込受付開始（予定）
...
const DetailPage = () => {
  ...
  datetime: "2025年8月1日　 19:15～20:45（予定）　※恶劣天气时4日延期",
  venue: "千葉県香取市　小見川大橋下流利根川河畔",
  access: "ＪＲ成田線「小見川駅」步行30分、或東関東自動車道「佐原香取IC」驾车约20分",
  organizer: "水郷小見川観光協会",
  price: "有料観覧席有/テーブル席2万1000円、イス席3000円　※6月2日からインターネットで申込受付開始（予定）",
  ...
  region: "chiba",
  description: "从明治41年（1908年）开始，持续为小见川夜空上色的传统“水乡大华花火大会”，迎来第126届。你可以欣赏到大约5，000发（预定）在通川河上爆炸的壮观烟花，包括关东地区最大的水下明星火、长玉、水下烟花、制作烟花、讯息烟花、花园（预定）等。全国烟火店和工厂的烟火师，带著自己引以为豪的烟火--“全国烟火大赛”，竞争美丽的“全国烟火大赛”也是一大看点。* 发射次数：5，000次，去年7，000次，观众：80，000次，去年110，000次",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
