...
const DetailPage = () => {
  ...
  region: "chiba",
  description: "围绕着手贺沼举行的柏市和我子市的夏季特色“手贺沼花火大会”。在平成30年（2018年）被选定为“想留给下一代的‘千叶文化资产’”的花火大会。梦幻般的水下烟花，以及连续发射数百个烟花的超大型 连续花火，包括尺玉在内的华丽烟花，将为夜空增添色彩。* 并非所有场地都有停车位。请不要开车来这里。※发射数：13500发，去年13500发，观众数：48万人，去年48万人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
