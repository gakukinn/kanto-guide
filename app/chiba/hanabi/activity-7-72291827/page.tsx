...
const pageData = {
  ...
  "region": "chiba",
  "activityType": "hanabi",
  "description": "* 会议日程将是过去的信息。关于即将举行的比赛的详细信息一旦确定，我们将更新。比赛将在位于千叶县和埼玉县边界的江户川宽阔的河床上举行。大会会场周围除了有由历史建筑物和古民居改装而成的咖啡店和餐厅外，还设置了120多个居民手工制作的剪纸行灯。在有趣的街道上欣赏烟花的地方也是吸引人的地方。",
