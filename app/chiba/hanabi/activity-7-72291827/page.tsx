...
const pageData = {
  ...
  "date": "2025年10月4日(土)",
  "time": "18：00至18：40",
  "venue": "流山1丁目~3丁目地先江户川堤",
  "access": "[火车]从流铁流山线流山线流山站或和平台站步行5分钟。从筑波快车流山中央公园站、南流山站、JR武藏野线南流山站步行25分钟",
  "weatherInfo": "小雨停了，暴风雨停了下来。",
  "parking": "×",
  ...
  "region": "chiba",
  "activityType": "hanabi",
  "description": "* 会日程将是过去的信息。关于即将举行的比的详细信息一旦确定，我们将更新。比赛将位于千叶县和埼玉县边界的江户川宽阔的河床上举行。大会会场周围除了由历史建筑物和古居民改装而成的咖啡店和餐厅外，还设置了120多个居民手工制作的剪纸行灯。在有趣的街道上欣赏烟花的地方也是吸引人的地方。",
  "highlights": "由于会场是在河边，所以可以欣赏到很多风景。烟花和音乐同步的“流山天空音乐剧”和“明星矿”是必看的地方。与埼玉县三乡市同时举办，每年都有很多人热闹非凡。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
...
export const metadata = {
  ...
  description: '【※大会项目为过往の情報。開催予定の大会详细信息将在确定后、情報を更新】千葉県と埼玉県の県境である江戸川の広大な河川敷で開催する。大会会場の周辺には、歴史的な建造物や古民家を改装したカフェやレストランがあるほか、住民手作りの切り絵行灯が約120基設置されている。趣き深い町並みも楽しみながら花火が見られるところも魅力の1つ。',
};
