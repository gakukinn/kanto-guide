 ...
 * 3. 开催期间: 2025年5月下旬～7月上旬　 拝観時間/8:00～17:00（閉山17:30）　※あじさい路で的紫阳花鑑賞/五分咲き～見頃が終わるまで、あじさい入場券（有料）を領布。詳細はホームページをご確認ください。
 * 4. 开催场所: 神奈川県鎌倉市　長谷寺（長谷観音）
 * 5. 交通方式: 江ノ島電鉄「長谷駅」から徒歩5分、或ＪＲ横須賀線「鎌倉駅」から巴士約10分「長谷観音前」下車
 * 6. 主办方: 未设置
...
const DetailPage = () => {
  ...
  datetime: "2025年5月下旬～7月上旬　 拝観時間/8:00～17:00（閉山17:30）　※あじさい路で的紫阳花鑑賞/五分咲き～見頃が終わるまで、あじさい入場券（有料）を領布。詳細はホームページをご確認ください。",
  venue: "神奈川県鎌倉市　長谷寺（長谷観音）",
  access: "江ノ島電鉄「長谷駅」から徒歩5分、或ＪＲ横須賀線「鎌倉駅」から巴士約10分「長谷観音前」下車",
  organizer: "",
