...
const activityData = {
  ...
  "region": "kanagawa",
  "description": "在相模川河口（湘南潮来）举行了作为湘南夏天的风景而受欢迎的“湘南平田花火大会”。以湘南的大海为背景，约3000发五彩缤纷的烟花被燃烧释放，在夏季的夜晚空中放生巨大的花朵。在节日目的后半部分，将举行与音乐和谐的音乐烟花表演，您可以欣赏到充满震撼力的烟花。※从平冢站南口开始的收费临时巴士运行：3000发，去年3000发观众：85000人，去年85000人",
  "activityType": "hanabi",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
