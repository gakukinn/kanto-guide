...
const DetailPage = () => {
  ...
  region: "kanagawa",
  description: "小田原酒川烟花节将在酒川河畔举行，届时将燃放约10，000发烟花，包括星光、音乐烟花、讯息烟花和4号烟花。除了以传统和情感为基础的传统烟花外，您还可以欣赏到烟花和音乐同步的华丽烟花表演等丰富多彩的烟花表演。在最后一场活动中，横跨清酒川的全长300米高30米的尼亚加拉烟花将出现，欢呼雀跃。* 发射次数：10，000，去年10，000，观众：250，000，去年250，000",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
