...
const pageData = {
  ...
  "time": "19：00 - 20：00（预定）",
  "venue": "海洋公园",
  "access": "[火车]从JR新杉田站或京滨急行金泽八景站乘横滨海滨线，在Kai-Park南口站或Kai-Park Shibaguchi站下车。从京滨急行金泽文库站步行20分钟MAP",
  ...
  "region": "kanagawa",
  "activityType": "hanabi",
  "description": "烟花大会在横滨市金泽区海之公园举行。大约3500发烟花将在60分钟内燃放。从被八岛岛、海洋公园和野岛环绕的海面上，五颜六色的烟花在横滨的夜空中燃放。各种各样的Starmine系列为比赛增添了华丽的色彩，而一年一度的大型Starmine则为决赛增添了色彩。",
...
export const metadata = {
  ...
  description: '横浜市金沢区海の公園で举办花火大会。60分間にわたって約3500発の花火が被燃放。八景島、海の公園、野島に囲まれた海上から、横浜の夜空に色とりどりの花火が打燃放がる。多様なスターマインの連続が大会を華やかに彩り、毎年恒例の特大スターマインがフィナーレを飾る。',
};
