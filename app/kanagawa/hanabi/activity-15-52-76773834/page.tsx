...
const pageData = {
  ...
  "access": "（电车）从JR相模原站乘坐巴士，水乡田名车站下车，步行5分。从JR渊野边站、上沟站或桥本站乘巴士，步行15分钟即可到达田名巴士站。【乘车】从相模纵贯道（圈央道）相模原爱川IC或相模原IC约20分钟※烟花节当天道路堵塞，建议您早点到达",
  "weatherInfo": "恶劣天气、相模川涨水时延期至2025年9月7日星期日",
  "parking": "未知",
  "price": "详见官网",
  ...
  "region": "kanagawa",
  "activityType": "hanabi",
  "description": "中央区诞生15周年纪念第52回相模原纳凉烟花大会将在相模原市举办，约燃放一万发烟花，是神奈川县规模最大的烟花大会之一。市民赞助席距离发射场极近，可近距离感受震撼烟花的魅力，特别是空中尼亚加拉和大型星幕烟花尤为精彩。会场周边设有众多摊位，可一边品尝街头美食，一边享受夏日节庆氛围。",
  "highlights": "在燃放烟花的同时，您还可以欣赏到在场内播放信息的信息烟花。请注意空中尼亚加拉和终曲的百花大战。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
...
export const metadata = {
  ...
  description: '約1万発という、神奈川県でも有数のスケールを誇る相模原市の花火大会。打燃放げ場所から一番近い市民協賛者席では、迫力ある花火を体感することが可以。特に空中ナイアガラや大连发烟花は必見。会場には多くの露店が並び、屋台料理を味わいながら祭の雰囲気も堪能可以。',
};
