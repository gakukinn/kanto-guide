 ...
 * 5. 交通方式: ＪＲ東海道本線「平塚駅」南口から「須賀港行」の巴士「終点」～徒歩5分、或圏央道「茅ヶ崎海岸IC」から車約5分、或小田原厚木道路「平塚IC」から車約20分
...
const DetailPage = () => {
  ...
  access: "ＪＲ東海道本線「平塚駅」南口から「須賀港行」の巴士「終点」～徒歩5分、或圏央道「茅ヶ崎海岸IC」から車約5分、或小田原厚木道路「平塚IC」から車約20分",
