...
const pageData = {
  ...
  "venue": "海老名運動公園",
  "access": "【电车】JR、小田急、相铁海老名站、海老名市役所乘坐免费接驳巴士约20分钟。从JR小田急厚木站或JR社家站步行15分钟地图",
  "weatherInfo": "恶劣天气取消。",
  "parking": "×",
...
export const metadata = {
  ...
  description: '【※大会项目为过往の情報。開催予定の大会详细信息将在确定后、情報を更新】神奈川県海老名市で開催され、毎年多くの来場者でにぎわう「えびな市民祭典」。会場内では一般団体によるブース出展やステージ出演など、さまざまな企画を実施し、海老名の「魅力」、「活力」、「地域力」を発信する。祭典のフィナーレを飾る花火は、約5000発が被燃放。色鮮やかな花火が、秋の澄みきった海老名の装点夜空。',
};
