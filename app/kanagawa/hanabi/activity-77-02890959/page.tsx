...
const pageData = {
  ...
  "time": "19：20至20：10",
  "venue": "由比浜海岸材木座海岸",
  "access": "【电车】从江之岛电铁由比滨站或和田冢站步行5分钟，从JR·江之岛电铁镰仓站步行15分钟※当天会场周边有交通限制地点",
  "weatherInfo": "如遇下雨、恶劣天气或巨浪，则取消",
  "parking": "×",
  "price": "是的，有销售计划。有沙滩座位。详情见官方网站",
  ...
  "region": "kanagawa",
  "activityType": "hanabi",
  "description": "在镰仓海岸举办的著名花火大会。以水中烟火为首，连续花火等约2500发烟火为夜空和海上增色。自1948年（昭和23年）开始以来，作为镰仓夏季的风物诗，这个大会一直受到喜爱和持续。由于预计会出现与时隔5年重新开放的上次相同规模的拥挤，因此推荐使用公共交通工具。另外，没有设置预备日，荒天时有时会中止。",
  "highlights": "从移动的船只扔到海中，在海上以扇状开放的水中烟火，是玉仓花火大会独有的传统演出。在阅读海浪和潮流的同时，扇形的景象呈现出独特的美丽与手工艺的气息。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
...
export const metadata = {
  ...
  description: '鎌倉海岸で繰り広放名物花火大会。水中花火をはじめ、连发烟花など約2500発の花火が夜空と海上装点。鎌倉夏の風物詩として1948年(昭和23年)の開始以来、長年愛され継続してきた大会だ。5年ぶりに再開された前回と同規模の混雑が想定されるため、公共交通機関の利用が推奨される。なお、予備日は設けられておらず、恶劣天气时中止となる場合がある。',
};
