 ...
 * 5. 交通方式: 地下鉄都営新宿線「篠崎駅」から徒歩15分、或ＪＲ総武線「小岩駅」から徒歩25分或者京成巴士「南小岩二丁目」～徒歩10分
 * 6. 主办方: 江戸川区、江戸川区花火大会実行委員会
 * 7. 料金: 有料観覧席有　※詳細は江戸川区花火大会ホームページを参照
...
const DetailPage = () => {
  ...
  access: "地下鉄都営新宿線「篠崎駅」から徒歩15分、或ＪＲ総武線「小岩駅」から徒歩25分或者京成巴士「南小岩二丁目」～徒歩10分",
  organizer: "江戸川区、江戸川区花火大会実行委員会",
  price: "有料観覧席有　※詳細は江戸川区花火大会ホームページを参照",
