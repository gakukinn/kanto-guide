  ...
  "media": [
    {
      ...
      "title": "立川祭典 国営昭和記念公園花火大会图片1",
      "alt": "立川祭典 国営昭和記念公園花火大会图片1",
      "caption": ""
    }
  ],
...
export const metadata = {
  title: '立川祭典 国営昭和記念公園花火大会 - 日本活动指南',
  description: '東京都立川市で举办立川祭典国営昭和記念公園花火大会。立川の夏の風物詩で、都内ではなかなかお目にかかれない尺玉、一尺五寸玉といった大迫力の花火やスターマインのほか、花火職人による競技大会での入賞作品である芸協玉など、観客を終始飽きさせない演出が特色だ。なお、毎年好評の有料観覧席は大会日が近づくと売り切れてしまうこともあるので、早めの購入がおすすめ。',
};
