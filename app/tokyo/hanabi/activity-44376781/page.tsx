...
const DetailPage = () => {
  ...
  region: "tokyo",
  description: "作为继承传统的两国川开烟花大会的活动而闻名的“隅田川烟花大会”，在2个会场举行。第1会场与第2会场合起来的烟火发射数量约为2万发。在第1会场，还将举行由两国烟火有关的业者，以及在国内代表性烟火大会上取得优秀成绩的10家业者组成的烟火比赛。※发射数量：2万发（两场合计，包含比赛球200发）观众数：95万人（两场合计）",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
