...
const pageData = {
  ...
  "region": "tokyo",
  "activityType": "hanabi",
  "description": "与位于荒川对岸的埼玉县户田市的“户田桥烟花大会”同时举行的烟花大会。以东京都内屈指可数的规模而豪豪，两岸约有1万5000发烟花。这里有很多景点，包括由日本最好的烟火师制作的“艺术玉”、东京最大的大烟花“Shaka-gazu玉”，以及将装饰最后一幕的大明星矿“天空中的尼亚加拉”。由于发射地点离观众席很近，肚子里回荡的声音也是其中的乐趣之一。",
...
export const metadata = {
  ...
  description: '荒川をはさんで対岸にある埼玉県戸田市の「戸田橋花火大会」と同時举办花火大会。東京都内屈指の規模を誇り、両岸で約1万5000発の花火が被燃放。恒例となっている日本最高峰の花火師が手掛けた「芸術玉」や東京最大級の大玉「尺五寸玉」、フィナーレを飾るワイドスターマイン「天空のナイアガラ」など、見どころが満載。打燃放げ場所が観客席に近いことから、おなかに響く音も醍醐味の一つ。',
};
