...
const DetailPage = () => {
  ...
  region: "tokyo",
  description: "两个烟花节将同时在东京的板桥区和埼玉县的户田市举行，这两个烟花节位于荒川对岸。在两岸发射约1万5000发烟火，是东京都内屈指可数的花火大会。这里有许多值得一看的地方，包括由日本最好的烟火师制作的“艺术玉”、东京最大的大玉“释迦神玉”和最后的大明星火“天空中的尼亚加拉”。由于发射地点离观众席很近，轰鸣声在你的肚子里回荡也是其中的一个乐趣。五个地点同时发射的大型连续花火将在质量和数量上得到升级，并将在开幕式和最后一场精彩的演出中进行。* 发射次数：15000枚，去年15000枚，观众人数：55万人，去年57万人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
