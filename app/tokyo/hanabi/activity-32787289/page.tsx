 ...
 * 5. 交通方式: 京成金町線「柴又駅」から徒歩10分、或北総鉄道北総線「新柴又駅」から徒歩15分、或ＪＲ常磐線・地下鉄千代田線「金町駅」或者京成金町線「京成金町駅」から徒歩20分
...
const DetailPage = () => {
  ...
  access: "京成金町線「柴又駅」から徒歩10分、或北総鉄道北総線「新柴又駅」から徒歩15分、或ＪＲ常磐線・地下鉄千代田線「金町駅」或者京成金町線「京成金町駅」から徒歩20分",
  ...
  region: "tokyo",
  description: "华丽持续进化的古老美好下町的烟火“葛饰纳凉烟火大会”，今年也会举办。包括星光、尼亚加拉、音乐烟花等最多4号烟花在内的约1万5000发烟花，为葛饰的夜空增色。因为发射地点离观众席很近，所以作为东京都内屈指可数的临场感满分的烟花大会而闻名。也有收费指定座位，可以在特等座位上品尝烟花的震撼力。悠闲地漫步在充满下町情绪的柴又帝释天参道，然后尽情欣赏烟花。你可以享受一个特别的夏日风景。※发射数：15，000发，去年15，000发观众数：去年770，000人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
