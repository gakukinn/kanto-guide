...
const pageData = {
  ...
  "region": "tokyo",
  "activityType": "hanabi",
  "description": "每年夏天举办的“八王子花火大会”，对八王子市民来说是熟悉的季节风景。大约有4000发烟花在夜空中绽放。作为会场的富士森公园是市民们喜爱的休息场所，头顶上盛开着巨大的花朵的景象令人印象深刻，让人感受到烟花爆炸的声音在心中回荡的现实感。",
  "highlights": "各种各样的燃放烟花，如星雷，是值得一看的。壮观的烟花照亮了八王子的夜空，你可以在观赏场地附近欣赏到烟花。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
