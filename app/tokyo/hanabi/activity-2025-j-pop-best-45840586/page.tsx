...
const pageData = {
  "name": "东京竞马场烟火2025 ~烟火和想听的J-POP BEST ~",
  ...
  "venue": "JRA東京競馬場",
  "access": "[电车]京王线府中赛马正门前站步行2分钟MAP",
  "weatherInfo": "下雨，暴风雨时取消。天气不好的情况下，实施的判断将于当天12：00在官方网站及SNS上发表。※途中中止的话，不退款",
  "parking": "* 请使用公共交通工具。",
  ...
  "region": "tokyo",
  "activityType": "hanabi",
  "description": "2025年的主题是“J-POP BEST”，与“昭和100年”的纪念年相称，配合大家都知道的名曲燃放烟火。以拥有约2公里路线的广阔赛马场为舞台，与音乐同步的大规模火势展开，是这里独特的体验。所有座位都是保留座位，您可以轻松地欣赏，而不必担心拥挤，而且还配备了卫生间和饮食摊位等设施，让广大年龄段的人都能享受到舒适的体验。从最近的火车站步行很短，交通便利也很吸引人，从东京也可以很容易地参观。",
...
export const metadata = {
  ...
  description: '2025年のテーマは「J-POP BEST」で、「昭和100年」という記念の年にふさわしく、 誰もが知る名曲に合わせて花火が打ちあがる。およそ2キロのコースを有する広大な競馬場を舞台に、音楽とシンクロした大規模な花火が繰り広放のは、ここだけの特別な体験。全席指定席で混雑を気にせずゆったり鑑賞でき、トイレや飲食ブースなどの設備も整っているため、幅広い世代が快適に楽しめる。会場は最寄り駅から徒歩すぐというアクセスの良さも魅力で、都内からも気軽に訪れることが可以。',
};
