...
// 活动类型配置 - 全部统一使用UniversalStaticDetailTemplate
...
const autoDetectActivityType = (text: string): ActivityType | null => {
  const activityKeywords = {
    ...
    // 传统祭典
    matsuri: ['祭', '祭り', '祭典', 'matsuri', '祇園祭', '例大祭', '夏祭り', '秋祭り', '神輿', '山車', '盆踊り', '夜店', '屋台'],
    
    // 花见会
    hanami: ['桜', '花見', 'はなみ', 'hanami', 'さくら', 'サクラ', '桜祭り', '桜祭典', '花見会', '桜並木', '桜の名所'],
    
    // 红叶狩
    momiji: ['紅葉', 'もみじ', 'モミジ', 'momiji', '紅葉狩り', '紅葉祭典', '秋の紅葉', '楓', 'かえで', 'カエデ'],
