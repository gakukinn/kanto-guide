 ...
 * 5. 交通方式: ＪＲ烏山線「烏山駅」步行5分～30分、或北関東自動車道「宇都宮上三川IC」驾车约50分
 * 6. 主办方: 山あげ祭実行委員会
...
const DetailPage = () => {
  ...
  access: "ＪＲ烏山線「烏山駅」步行5分～30分、或北関東自動車道「宇都宮上三川IC」驾车约50分",
  organizer: "山あげ祭実行委員会",
  ...
  region: "kitakanto",
  description: "作为八云神社神社一年一度的节日庆典的奉献活动而举行的“山形祭”以使用当地特产乌山和纸制作的“张子人偶”为舞台背景，并表演正宗的户外歌舞伎舞蹈。从设置在观众面前的舞台到道路上约100 m之间，将有合理的山、馆、桥等配置，以这些为背景，由町内的舞者们表演绚烂豪华的舞蹈。在一个舞台结束后，舞台被转移到下一个地方，每天有4到6次的表演。它被指定为国家重要的非物质民间文化财产，并于2016年被登记为联合国教科文组织非物质文化遗产，是33个“山·花车·屋台活动”之一。",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
