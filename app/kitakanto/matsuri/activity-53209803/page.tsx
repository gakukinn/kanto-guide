 ...
 * 
 * 十一项核心数据:
 * 1. 名称: 下館祇園祭典（しもだてぎおん祭典）
 * 2. 所在地: 〒308-0031　茨城県筑西市
 * 3. 开催期间: 2025年7月24日～27日　 【24日～26日】18:00～22:00　　【27日】6:00～9:00　※最新情報は官网参照
...
const DetailPage = () => {
  ...
  name: "下館祇園祭典（しもだてぎおん祭典）",
  address: "〒308-0031　茨城県筑西市",
  datetime: "2025年7月24日～27日　 【24日～26日】18:00～22:00　　【27日】6:00～9:00　※最新情報は官网参照",
  venue: "茨城県筑西市　下館駅前通りおよびその周辺　五行川大橋　ほか",
  access: "ＪＲ水戸線「下館駅」北口からすぐ",
  organizer: "下館祇園祭典実行委員会",
  price: "",
  ...
  region: "kitakanto",
  description: "以筑西最大的夏季祭而闻名的“下馆祇园祭”，以大町的羽黑神社为中心举行。从明治28年（1895年）起就有历史的明治神轿、羽黑神社的相殿神·玉依姬的女子神轿、每年举行的日本最重的神轿的平成神轿的三座渡御、以及从旧下馆市内各处聚集的30多座町会神轿的联合渡御等都是值得一看的。在最后一天的清晨，还将举行川渡御，将明治神轿抬到市内的五行河。",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
      ...
      title: "下館祇園祭典（しもだてぎおん祭典）图片1",
      alt: "下館祇園祭典（しもだてぎおん祭典）图片1",
      caption: ""
    }
  ]
};
