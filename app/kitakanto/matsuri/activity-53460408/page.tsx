...
const DetailPage = () => {
  ...
  access: "東武伊勢崎線「木崎駅」からシャトル巴士約5分、或北関東自動車道「伊勢崎IC」驾车约30分、或関越自動車道「花園IC」驾车约45分、或東北自動車道「館林IC」驾车约50分",
  ...
  region: "kitakanto",
  description: "在“尾岛灯笼祭祭”中，高达7米的扇灯笼祭和灯笼祭太鼓的运行以其壮而闻名。“弘前灯笼祭”之所以出现在尾岛的祭祀活动中，是因为江户时代津轻藩的飞地位于太田市（现大馆町等）。伴随着“祭典吆喝（Yayadoo）”的口号，大约十台灯笼祭和10尺大鼓在会场游行。其中，在节日结束时举行的灯笼祭 太鼓和祭典音乐的联合表演是最值得注意的。广崎市的特产也被出售，作为筑谷物产市场，吸引了很多人。※由木崎站运行临时巴士",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
      type: "image" as const,
      url: "https://j-matsuri.com/wp-content/uploads/2020/09/ojima灯笼祭matsuri-2-1024x768.jpg",
