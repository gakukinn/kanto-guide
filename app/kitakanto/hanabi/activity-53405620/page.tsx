...
const DetailPage = () => {
  ...
  region: "kitakanto",
  description: "足利花火大会创办于明治36年（1903年），是一个拥有120年以上传统和历史的花火大会。作为关东地区屈指可数的花火大会而广为人知，每年都有来自关东一带的众多观众前来观看，成为足利最热闹的一天。大约20000支烟花（计划中）将照亮石贺的夜空，包括连续发射的5号烟花、同时发射的长玉、大玉和宽星地雷。“尼亚加拉”的高潮尤其令人叹为观止。※发射数：去年2万发观众数：去年45万人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
