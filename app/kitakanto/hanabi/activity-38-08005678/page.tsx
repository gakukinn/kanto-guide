...
const pageData = {
  ...
  "access": "（车）距离圈央道境古河IC约10分钟（约3. 5 km）的花火大会当天预计会堵塞，因此从境古河IC需要约3小时的时间。当天会场周边有交通管制",
  ...
  "region": "kitakanto",
  "activityType": "hanabi",
  "description": "在茨城县境町的利根川河边举行的大规模烟花节。在茨城县内外设立地点的全国有名的4家有名的烟花师的竞演能够实现。他在全国烟火活动中也有获奖经验。在樱花河边公园（通川河边），30，000发烟花照亮了夏天的夜空。可以在收费观众席上悠闲地观看与音乐一起燃烧的烟花。",
  "highlights": "与音乐同步的烟花表演，以及动态的星光在眼前升起的景象，都是令人叹为观止的。最大号数是开花时达到300米的10号玉，作为在关东地区举行的花火大会，规模较大。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
...
export const metadata = {
  ...
  description: '茨城県境町の利根川河川敷で举办大規模な花火大会。茨城県内外に拠点を構える全国的に知られる有名花火師4社の競演が実現。全国花火競技大会でも受賞経験のある実力派だ。さかいリバーサイドパーク(利根川河川敷)を舞台に、3万発の花火が夏の装点夜空。音楽とともに被燃放花火を、有料観覧席でゆったり観覧することが可以。',
};
