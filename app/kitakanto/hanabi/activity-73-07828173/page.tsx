...
const pageData = {
  ...
  "region": "kitakanto",
  "activityType": "hanabi",
  "description": "* 会日程将是过去的信息。关于预定召开的大会的详细情况，将在决定后更新信息。这是关东地区规模最大的大会，将在埼玉县小山市的清流思川举行。今年是该市70周年纪念日，我们将庆祝2024年夏季节日“向天堂许可的烟火!”以make h\~为主题，发射了各种各样的烟花。会场设置有收费座位，可以欣赏到震撼力十足的烟花。",
...
export const metadata = {
  ...
  description: '【※大会项目为过往の情報。開催予定の大会详细信息将在确定后、情報を更新】栃木県小山市の清流思川を会場に举办、関東有数の規模を誇る大会。市制70周年の今年は、おやまサマーフェスティバル2024「天に願いを 希望の花火！～make history～」をテーマに様々な花火が被燃放。会場には有料席が設けられ迫力満点の花火が堪能可以。',
};
