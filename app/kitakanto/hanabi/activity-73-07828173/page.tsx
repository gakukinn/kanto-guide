...
const pageData = {
  ...
  "region": "kitakanto",
  "activityType": "hanabi",
  "description": "* 会议日程将是过去的信息。关于预定举办的大会的详细情况，将在决定后更新信息。这是关东地区规模最大的大会，将在埼玉县小山市的清流思川举行。今年是该市70周年纪念日，我们将庆祝2024年夏季节日“向天堂许愿的烟火!”以make h\~为主题，发射了各种各样的烟花。会场设有收费座位，可以欣赏到震撼力十足的烟花。",
