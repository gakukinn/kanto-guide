...
const DetailPage = () => {
  ...
  region: "kitakanto",
  description: "以神轿与屋台的市内渡御，以及壮的神轿的川渡御为看点的“真冈之夏祭荒神祭”持续3天举行。从第一天的神轿的宫出到町会渡御开始，第二天市中心成为步行者天国，举行“祭典广场”。主要的荒宫神轿 神輿、儿童神輿、每个地区的神輿、初中生手工制作的神輿和花车摊位都出现了，许多音乐家为节日增添了光彩。在夜晚的花火大会上，神轿在五行川“川渡御”中，最多4号玉和星光等约2万发发，以音乐和激光光线的华丽而有震撼力的演出，吸引观众的目光。在最后一天，将有充满传统的宫殿奉献灯和英勇的宫殿入口，以及花车摊位上的音乐和撞击。* 发射次数：20000次观众人数：170000人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
