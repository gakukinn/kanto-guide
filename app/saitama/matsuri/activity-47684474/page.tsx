...
const DetailPage = () => {
  ...
  region: "saitama",
  description: "举行水上安全祈愿和水难供养的“船玉祭”最后的烟火大会，将在长岩垫举行。以“花在空中和静宫”为主题，将燃放烟花、星光、尼亚加拉、讯息烟花、音乐烟花、尺玉等约3000发烟花，庆典达到高潮。在“船玉祭”中，宝山神社-神社神社的祭司登上一艘船，在清澈的溪流中进行净化净化仪式，两艘万德号在舞台音乐中缓慢地上下移动。另一方面，大量的灯笼被冲走，为在水难中牺牲的人们举行供养仪式。发射次数：3 000次。",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
