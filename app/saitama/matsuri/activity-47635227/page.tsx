 ...
 * 5. 交通方式: 朝霞会場まで/東武東上線「朝霞駅」南口から徒歩5分　北朝霞会場まで/ＪＲ武蔵野線「北朝霞駅」或者東武東上線「朝霞台駅」から徒歩5分
 * 6. 主办方: 朝霞市コミュニティ協議会（朝霞市民祭典実行委員会）
 * 7. 料金: 有料観覧席有　※詳細はホームページ参照
...
const DetailPage = () => {
  ...
  access: "朝霞会場まで/東武東上線「朝霞駅」南口から徒歩5分　北朝霞会場まで/ＪＲ武蔵野線「北朝霞駅」或者東武東上線「朝霞台駅」から徒歩5分",
  organizer: "朝霞市コミュニティ協議会（朝霞市民祭典実行委員会）",
  price: "有料観覧席有　※詳細はホームページ参照",
