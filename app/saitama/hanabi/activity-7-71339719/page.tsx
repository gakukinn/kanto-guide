...
export const metadata = {
  ...
  description: '【※大会项目为过往の情報。開催予定の大会详细信息将在确定后、情報を更新】関東有数の規模を誇る、埼玉県さいたま市の「さいたま市花火大会」は3会場に分けて举办花火大会。オープニングを飾る大和田公園会場は見通しの良さが自慢。早打ち、スターマインなど多種多様な花火が打燃放がり、さいたまの夏の夜空に大輪の花火が描かれる。',
};
