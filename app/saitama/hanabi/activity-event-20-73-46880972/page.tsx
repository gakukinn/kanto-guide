...
const activityData = {
  ...
  "datetime": "2025年8月9日　 19:00～21:00（変更となる場合有）　※荒天の場合は10日、16日、17日の順に延期",
...
export async function generateMetadata() {
  return {
    ...
    description: '尺玉やスターマインなどの花火が装点夜空恒例の花火大会が、熊谷の荒川河川敷で行われます。昭和23年（1948年）、戦災からの立ち直りを願って「大熊谷復興花火大会」として開催されたのが始まりで、県内でも...',
  };
}
