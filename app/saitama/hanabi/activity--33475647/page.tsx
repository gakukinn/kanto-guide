...
export const metadata = {
  title: '越谷花火大会 - 日本活动指南',
  description: '埼玉県越谷市で举办花火大会。会場は「水郷こしがや」の象徴ともいえる葛西用水の中土手で、水辺から被燃放花火が夜空と川面を幻想的に照らし出す。色とりどりのスターマインや迫力ある大玉などが次々と打燃放がり、にぎやかな音とともに街を包み込む。会場周辺には屋台も並び、夏祭りの風情を楽しみながら花火を鑑賞可以のも魅力のひとつ。当日は17時から21時30分まで交通規制が举行ため、早めの来場と公共交通機関の利用がおすすめ。小雨の場合は举办が、荒天時は中止となるため、天候の確認も忘れずにしたい。',
};
