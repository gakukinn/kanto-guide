...
const pageData = {
  ...
  "access": "[电车]东武铁道越谷站步行6分钟MAP",
  "weatherInfo": "小雨决定了。恶劣天气取消。",
  "parking": "×",
  "price": "无（No）",
  ...
  "region": "saitama",
  "activityType": "hanabi",
  "description": "在埼玉县的越谷市举行的烟花节。会场位于葛西用水的中岸，可以说是“水乡轿屋”的象征，从水边燃放的烟火，奇妙地照亮了夜空和河流的表面。五颜六色的星光和令人震撼的大宝石一个接一个地撞击着城市，伴随着热闹的声音。会场周围也有摊位，可以在享受夏日祭典风情的同时欣赏烟火的同时，也是魅力之一。由于当天17：00至21：30实施交通管制，建议提早到场和使用公共交通。如果下雨，活动将举行，但如果天气恶劣，活动将取消，所以别忘了检查天气情况。",
  "highlights": "从葛西用水的中州发射的约5000发烟花，汇集了Starmine和连发烟花等精彩的演出，将河面上映出的鲜艳的灯光和声音融为一体，将观众包围在一起。摊位也很丰富，你可以在享受摊位美食的同时度过夏日的时光。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
...
export const metadata = {
  title: '越谷花火大会 - 日本活动指南',
  description: '埼玉県越谷市で開催される花火大会。会場は「水郷こしがや」の象徴ともいえる葛西用水の中土手で、水辺から打ち上げられる花火が夜空と川面を幻想的に照らし出す。色とりどりのスターマインや迫力ある大玉などが次々と打ち上がり、にぎやかな音とともに街を包み込む。会場周辺には屋台も並び、夏祭りの風情を楽しみながら花火を鑑賞できるのも魅力のひとつ。当日は17時から21時30分まで交通規制が実施されるため、早めの来場と公共交通機関の利用がおすすめ。小雨の場合は開催されるが、荒天時は中止となるため、天候の確認も忘れずにしたい。',
};
