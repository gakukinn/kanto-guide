...
const activityData = {
  ...
  "region": "saitama",
  "description": "为了祝贺埼玉市烟花节的开幕式，烟花节将在小和田公园举行。早打、星矿等被发射，为夏天的夜空添了华丽的色彩。小和田公园会场的特点是景色优美，从任何方向都能欣赏到美丽的烟花。埼玉市烟花大会在浦和地区（大间木公园）和岩地区（岩文化公园）也举行。※发射数：去年4000发观众数：去年90，000人",
  "activityType": "hanabi",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
...
export async function generateMetadata() {
  return {
    ...
    description: 'さいたま市花火大会のオープニングを飾る花火大会が、大和田公園で開催举行。早打ち、スターマインなどが打燃放げられ、夏の夜空を華やかに彩ります。大和田公園会場は、見通しの良さが特徴でどの方角からも美し...',
  };
}
