...
const pageData = {
  ...
  "time": "19：00至21：00",
  "venue": "寄居町玉淀河原",
  "access": "【电车】JR·东武铁道·秩父铁道寄居站南口步行15分 【车】从关越道花园IC沿国道140号向秩父方向约15分钟※当天会场周边有交通限制地点",
  ...
  "region": "saitama",
  "activityType": "hanabi",
  "description": "在埼玉县寄居町举办，自1931年（昭和6年）开始持续至今的历史花火大会。居住玉淀水天宫祭是为了祈祷被称为“关东第一水祭”的水难而举行的祭祀活动，作为祭祀活动，在县指定名胜“玉淀”的河滩上举行花火大会。烟花的发射从19点开始进行，闪亮星雷和装置烟花等其他具一格的烟花很有魅力。",
