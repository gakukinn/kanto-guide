...
const pageData = {
  ...
  "region": "saitama",
  "activityType": "hanabi",
  "description": "这是自1948年（昭和23年）持续的传统活动，在埼玉县拥有悠久历史的花火大会。传达婚礼和生日信息的“信息烟花”也是特色活动。会场的景色很好，即使从远处也能看到，漆黑的夜空中也可以看到壮观的烟花。此外，河岸上还有约500家夜店林立，令人印象深刻。",
  "highlights": "将发射尺玉和星雷等约1万发。信息烟花和多个赞助者的“花火!“广域星雷”等看点满满的烟花升起。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
