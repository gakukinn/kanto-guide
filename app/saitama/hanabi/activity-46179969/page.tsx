...
const DetailPage = () => {
  ...
  region: "saitama",
  description: "为荒川夜空上色的“户田桥烟火大会天空幻想”今年也将举行。与对岸的“鸟鸟烟火大会”合起来，将会发放星光、音乐烟火、尺玉等首都圈最大规模的约1万5000发烟火。有两个只有在这里才能看到的比赛的联合节目，如令人震撼的同步演出。东西地区也有不同的享受方式，东侧也有可以在眼前观赏烟火的新座位种类登场。在这里，您可以享受最好的烟火体验。※发射数量：1万5000发，去年1万5000发（※全部与烟火大会合计）观众数：去年45万人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
