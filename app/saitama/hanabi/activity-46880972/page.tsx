...
const DetailPage = () => {
  ...
  region: "saitama",
  description: "在熊谷的荒川河边举行了一年一度的烟花节，其中包括尺玉和连续花火等烟花，照亮了夜空。昭和23年（1948年），为了从战灾中恢复，以“大熊谷复兴花火大会”的形式开始举办，在县内也作为历史悠久的花火大会而知名。尺玉等约1万发被燃放，信息烟花和复数的赞助者的“花火! 大型连续花火”等也是看点。※发射数：去年1万发观众数：去年42万人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
