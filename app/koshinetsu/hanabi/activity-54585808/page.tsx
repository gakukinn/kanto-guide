 ...
 * 5. 交通方式: ＪＲ身延線「市川大門駅」から徒歩10分、または中央自動車道「甲府南IC」から車約20分、または中部横断自動車道「増穂IC」から車約5分
 * 6. 主办方: 市川三郷町ふるさと夏まつり実行委員会
 * 7. 料金: 有料観覧席あり/ダイナミックVIP席10万円、ダイナミックリクライニング席2万円、通常席4000円～　ほか
 * 8. 联系方式: 市川三郷町ふるさと夏まつり実行委員会　055-272-1101
...
const DetailPage = () => {
  ...
  access: "ＪＲ身延線「市川大門駅」から徒歩10分、または中央自動車道「甲府南IC」から車約20分、または中部横断自動車道「増穂IC」から車約5分",
  organizer: "市川三郷町ふるさと夏まつり実行委員会",
  price: "有料観覧席あり/ダイナミックVIP席10万円、ダイナミックリクライニング席2万円、通常席4000円～　ほか",
  contact: "市川三郷町ふるさと夏まつり実行委員会　055-272-1101",
