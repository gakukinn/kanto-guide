...
const DetailPage = () => {
  ...
  region: "koshinetsu",
  description: "在武田信玄活跃的时代，被认为是作为战争的狼烟而开始的市川烟花，在江户时代被认为是日本三大烟花之一，是在为市川和纸的兴盛做出贡献的纸工“甚左卫门”的忌日7月20日举行。平成元年（1989年），作为山梨县最大规模的花火大会复活，现在每年8月7日（烟火之日）举办。2025年的主题是“光的轨迹--旋转的思想，连接的未来--”，伴随着音乐，长玉、超大的星光、主题火、讯息烟花等将照亮夜空，将迎来一个盛大的结局。它的特点是具有故事性的节目构成，每年有18万多人前来参观，非常热闹。* 发射次数：20000次，去年20000次观众：180000次，去年180000次",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
