 ...
 * 3. 开催期间: 2025年8月2日～3日　 打上時間/19:20～21:10　※最新情報は官网参照
 * 4. 开催场所: 新潟県長岡市　信濃川河川敷
 * 5. 交通方式: ＪＲ信越本線・上越新幹線「長岡駅」步行30分
 * 6. 主办方: 一般財団法人長岡花火財団
...
const DetailPage = () => {
  ...
  datetime: "2025年8月2日～3日　 打上時間/19:20～21:10　※最新情報は官网参照",
  venue: "新潟県長岡市　信濃川河川敷",
  access: "ＪＲ信越本線・上越新幹線「長岡駅」步行30分",
  ...
  region: "koshinetsu",
  description: "“长冈祭大花火大会”将在信浓川河边举行，以纪念在长冈空袭中丧生的人们，感谢致力于复兴的先辈，以及对复兴与永久和平的愿望等，承载着长冈市民的特殊愿望。2025年，以“祈祷绽放”为主题，将举行尼亚加拉、维苏比亚斯超大型星光、超大型星光等烟花的燃放。在信诺河的两岸都设置了观众席，充分利用了可以从两个方向观看烟花的特点，以竹玉为中心的许多演出而闻名。其中，开花宽约650m的正三尺玉和开花宽约2km的不死鸟在夜空中飞舞的独一无二的烟火“复兴祈愿烟火凤凰”是必看的，将长冈的夜空涂上鲜艳的色彩。※发射人数：非公开观众数：去年34万人（2天）",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
