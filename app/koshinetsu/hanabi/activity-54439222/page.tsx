...
const DetailPage = () => {
  ...
  region: "koshinetsu",
  description: "这是在雨季的同时举行的花火大会。2025年，作为“山梨市制施行20周年纪念事业”，将比往年增加约2000发，实施。4号球、早打、星光、大星光、制作烟火等，使夜空变得华丽，在富福井河清澈的溪流和万里林绿色的大自然的背景下施放的烟火吸引了观众的目光。由于发射地点和观赏地点很近，你可以感受到令人叹为观止的震撼力。* 发射次数：5000枚，去年3000枚，观众人数：25000人，去年20000人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
