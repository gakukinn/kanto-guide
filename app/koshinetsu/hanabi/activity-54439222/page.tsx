 ...
 * 3. 开催期间: 2025年7月26日　 花火燃放/19:30～21:00（予定）　※小雨決行、恶劣天气时翌日に順延
 * 4. 开催场所: 山梨県山梨市　笛吹川万力大橋下流
 * 5. 交通方式: ＪＲ中央本線「山梨市駅」步行3分
...
const DetailPage = () => {
  ...
  datetime: "2025年7月26日　 花火燃放/19:30～21:00（予定）　※小雨決行、恶劣天气时翌日に順延",
  venue: "山梨県山梨市　笛吹川万力大橋下流",
  access: "ＪＲ中央本線「山梨市駅」步行3分",
  ...
  region: "koshinetsu",
  description: "这是在雨季的同时举行的花火大会。2025年，作为“山梨市制施行20周年纪念事业”，将比往年增加约2000发，实施。4号球、早打、星光、大星光、制作烟火等，使夜空变得华丽，在富福井河清澈的溪流和万里林绿色的大自然的背景下施放的烟火吸引了观众的目光。由于发射地点和观赏地点很近，你可以感受到令人叹为观止的震撼力。* 发射次数：5000枚，去年3000枚，观众人数：25，000人，去年20，000人",
  themeColor: "red",
  status: "scheduled",
  media: [
    {
