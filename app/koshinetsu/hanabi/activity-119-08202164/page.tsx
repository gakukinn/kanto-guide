...
const pageData = {
  ...
  "time": "18:00～19:30",
  "venue": "長野大橋西側 犀川第2緑地",
  "access": "【電車】JR長野駅東口から徒歩30分MAP",
  "weatherInfo": "雨天決行。自然災害が発生した際は中止(延期日なし）",
  "parking": "×",
  "price": "あり\n売り切れ次第終了。※詳細は公式サイトを確認",
  ...
  "highlights": "絢爛豪華な花火が晩秋の澄んだ夜空を彩り、毎年好評の音楽と花火のコラボレーション「ミュージックスターマイン」や、「超ワイド特大スターマイン」など、日本屈指の煙火師による華麗な競演が楽しめる。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
