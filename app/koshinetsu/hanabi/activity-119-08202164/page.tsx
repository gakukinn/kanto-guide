...
export const metadata = {
  ...
  description: '長野県長野市で举行、全国でも珍しい11月の花火大会。1899年(明治32年)に始まり、善光寺の門前町として発展してきた、長野の歴史と伝統を誇る。熟練の煙火師のみを大会に参加させたことから、「出世煙火」といわれるようになり、現在でも良質な花火を打燃放げる全国有数の大会の一つに数えられている。',
};
