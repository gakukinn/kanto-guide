/**
 * 祇园柏崎祭典 海の大花火大会 详情页面
 * 自动生成于 2025-06-29T06:21:17.303Z
...
const pageData = {
  ...
  "region": "koshinetsu",
  "activityType": "hanabi",
  "description": "代表新泻县柏崎市夏天的大型烟花活动。被称为河的长冈、山的片贝、海的柏崎和越后三大烟花之一。由于新型冠状病毒的蔓延，连续2年被中止，但在2022年时隔3年再次举办。2025年，16000发烟花将在柏崎的夜空中燃放。",
  "highlights": "以海中天空星光为首，利用大海宽度的600米宽的星光，只有在柏崎才能看到的尺玉100发齐射等，百花争乱的烟火令人感动。",
  "themeColor": "red",
  "status": "scheduled",
  "media": [
    {
      ...
      "title": "祇园柏崎祭典 海の大花火大会图片1",
      "alt": "祇园柏崎祭典 海の大花火大会图片1",
      "caption": ""
    }
  ],
  "detailLink": "/koshinetsu/hanabi/activity--08787262",
  "createdAt": "2025-06-29T06:21:17.302Z",
...
export const metadata = {
  title: '祇园柏崎祭典 海の大花火大会 - 日本活动指南',
  description: '新潟県柏崎市の夏を代表する一大花火活动。川の長岡、山の片貝、海の柏崎と、越後三大花火の一つに数えられている。新型コロナウイルスのまん延により2年連続で中止になっていたが、2022年に3年ぶりに開催された。2025年も、1万6000発の花火が柏崎の夜空に打ちあがる。',
};
