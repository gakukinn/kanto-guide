 ...
 * 5. 交通方式: 北陸新幹線「上田駅」から徒歩5分、或上信越自動車道「上田菅平IC」から車約15分
 * 6. 主办方: 信州上田大花火大会実行委員会
 * 7. 料金: 有料観覧席有　※桟敷席/1万9800円、立ち見スペース5500円
...
const DetailPage = () => {
  ...
  access: "北陸新幹線「上田駅」から徒歩5分、或上信越自動車道「上田菅平IC」から車約15分",
  organizer: "信州上田大花火大会実行委員会",
  price: "有料観覧席有　※桟敷席/1万9800円、立ち見スペース5500円",
