 ...
 * 8. 联系方式: ぎおん柏崎祭典協賛会（柏崎市産業振興部商業観光課内）　0257-21-2334
...
const DetailPage = () => {
  ...
  organizer: "ぎおん柏崎祭典協賛会",
  price: "花火大会/有料観覧席有　※2025年の申し込みは終了",
  contact: "ぎおん柏崎祭典協賛会（柏崎市産業振興部商業観光課内）　0257-21-2334",
  ...
  media: [
    {
      ...
      title: "ぎおん柏崎祭典（ぎおんかしわざき祭典）图片1",
      alt: "ぎおん柏崎祭典（ぎおんかしわざき祭典）图片1",
      caption: ""
    }
  ]
};
