 ...
 * 目标网站: https://hanabi.walkerplus.com/launch/ar0310/
...
const crawledData = {
  ...
  source: 'https://hanabi.walkerplus.com/launch/ar0310/',
  ...
  async requestHandler({ page, request, log }) {
    ...
    try {
      ...
      $('li').each((index, element) => {
        ...
        if (!href || !href.includes('/detail/ar0310e')) return;
        ...
        if (
          ...
          const nextUrl = nextHref.startsWith('http')
            ...
            : nextHref.startsWith('/')
              ...
              : `https://hanabi.walkerplus.com/launch/ar0310/${nextHref}`;
...
// 启动爬虫
async function runKitakantoHanabiCrawler() {
  console.log('\n🚀 启动北関東花火大会数据抓取...');
  console.log('📡 目标网站: https://hanabi.walkerplus.com/launch/ar0310/');
  console.log('🛠️ 技术栈: Playwright+Cheerio+Crawlee');
  console.log('⚠️ 商业标准: 严格真实数据，绝不编造\n');

  try {
    console.log('🔧 开始启动爬虫...');
    await crawler.run(['https://hanabi.walkerplus.com/launch/ar0310/']);
    console.log('✅ 爬虫运行完成');
    ...
    const filename = `kitakanto-hanabi-crawlee-${timestamp}.json`;
...
export { crawledData, runKitakantoHanabiCrawler };
