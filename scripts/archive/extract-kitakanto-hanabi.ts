/**
 * 北关东花火大会数据提取脚本
 * 基于Walker Plus官方数据 (ar0308, ar0309, ar0310)
 * 
 * 数据来源：
 * - 茨城县：https://hanabi.walkerplus.com/ranking/ar0308/
 * - 栃木县：https://hanabi.walkerplus.com/ranking/ar0309/
 * - 群马县：https://hanabi.walkerplus.com/ranking/ar0310/
 */
...
const kitakantoHanabiEvents: HanabiEvent[] = [
  // 茨城县重大花火大会
  {
  ...
  },
  {
    ...
    location: "那須郡那須町・那須高原りんどう湖フミリー牧场",
    prefecture: "栃木県",
    category: "湖畔花火",
    highlights: [
      "湖面水中・水上花火",
...
function generateKitakantoHanabiData() {
  const data = {
    ...
    dataSource: "Walker Plus Official (ar0308, ar0309, ar0310)"
  };
...
try {
  ...
  writeFileSync('src/data/kitakanto-hanabi.json', jsonData);
  
  console.log('✅ 北关东花火大会数据生成成功！');
  console.log(`📊 总计 ${kitakantoHanabiEvents.length} 个重大花火大会`);
  console.log('📍 覆盖地区：茨城県、栃木県、群馬県');
  console.log('🌐 数据来源：Walker Plus 官方 (ar0308, ar0309, ar0310)');
...
`;
  ...
  writeFileSync('data/kitakanto-hanabi-update-report.md', report);
