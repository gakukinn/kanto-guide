...
export const getMonthName = (
  monthId: number
): { chinese: string; traditional: string; urlPath: string } => {
...
export const activityConfig: { [key: string]: Activity } = {
  hanabi: {
    id: 'hanabi',
    name: '花火大会',
    description: '夏夜的绚烂烟花盛宴',
    icon: '🎆',
  },
  matsuri: {
    id: 'matsuri',
    name: '祭典',
    description: '体验日本传统文化的热闹庆典',
    icon: '🏮',
  },
  hanami: {
    id: 'hanami',
    name: '花见',
    description: '樱花树下的春日赏花会',
    icon: '🌸',
  },
  momiji: {
    id: 'momiji',
    name: '红叶狩',
    description: '秋日山野的红叶美景',
    icon: '🍁',
  },
  illumination: {
    id: 'illumination',
    name: '灯光秀',
    description: '冬季的梦幻彩灯装饰',
    icon: '💡',
  },
  culture: {
    id: 'culture',
    name: '文化艺术',
    description: '探索博物馆、美术馆和历史遗迹',
    icon: '🎭',
  },
};
