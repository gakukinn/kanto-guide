...
export const edogawaHanabiData: HanabiData = {
  ...
  name: '第50回江戸川区花火大会',
  _sourceData: {
    japaneseDescription: '第51回 江戸川区花火大会',
  ...
  walkerPlusUrl: 'https://hanabi.walkerplus.com/detail/ar0313e00863/',
  tags: {
    timeTag: '8月',
    regionTag: '东京',
    typeTag: '花火',
  ...
  venues: [
    {
      name: '江戸川河川敷（都立筱崎公园先）',
      location: '東京都江戸川区 江戸川河川敷(都立篠崎公園先)',
      startTime: '19:15',
      features: [
        '河川敷开阔视野',
        '多层构造花火',
  ...
  mapInfo: {
    hasMap: true,
    mapNote:
      '江戸川河川敷（都立筱崎公园先），当日17:00-22:00会场周边交通规制实施。车辆、自行车入场禁止',
    parking: '无停车场（车辆入场禁止）',
  },
  ...
  mapEmbedUrl:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3239.1651234567!2d139.9345678901!3d35.7123456789!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188559c5b8c5c5%3A0x7e4c5e5b8a2c8c8c!2z6YO96ZGf5bed5Yy65r2t5bSO6aeF!5e0!3m2!1sja!2sjp!4v1600000000000!5m2!1sja!2sjp',
};
