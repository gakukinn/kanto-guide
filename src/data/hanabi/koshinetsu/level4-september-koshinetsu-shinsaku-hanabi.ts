...
export const shinsakuHanabiData: HanabiData = {
  ...
  year: 2025,
  date: "2025-09-06",
  displayDate: "2025年9月6日",
  time: '预选：20:30～20:50（9/613）、18:30～18:50（9/2027）、决赛：17:30～17:50',
  duration: '约20分钟',
  ...
  title: '全国新作花火挑战杯2025',
  description:
    '6年来首次复活的全国新作花火竞技大会。以诹访湖为舞台，全国选拔的20名烟火师不拘泥于传统技术，以崭新发想和独创技术创作艺术性极高的新作花火竞演。通过分散方式的竞技花火决定2025年度优胜者。',
  tags: {
    timeTag: '9月',
    regionTag: '甲信越',
    typeTag: '花火',
  ...
  history: {
    established: 2019,
    significance: '全国新作花火竞技大会作为2019年至开催、6年来首次复活',
  ...
  tips: [
    {
      ...
      items: [
        '预选4回与决赛的开催时间不同需要注意',
        '9月6日13日是20:30开始、9月20日27日是18:30开始',
      ],
    },
    {
      category: '观览信息',
      items: ['观览免费、无有料席', '诹访湖畔自由观览'],
    },
    {
      category: '准备事项',
      items: ['秋季夜间较冷需防寒对策', '雨天决行、台风直击时顺延'],
    },
  ],
  contact: {
  ...
  mapEmbedUrl:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3222.8!2d138.1!3d36.0!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzfCsDE4JzAwLjAiTiAxMzjCsDQ4JzAwLjAiRQ!5e0!3m2!1sja!2sjp!4v1234567890123!5m2!1sja!2sjp',
  website: 'https://suwako-hanabi.com/shinsaku/',
  related: {
