...
export const asaharaHanabiData: HanabiData = {
  ...
  description:
    '三尺玉的発祥地作为知新潟県小千谷市片貝町在200年的伝統将誇「片貝祭典奉納大煙火」。最大的注目是世界最大和进行四尺玉花火的打上在、其他在是的规模感将生在味。三尺玉的木筒将引張「筒引」「玉送」等花火在伝統行事也行、町中的花火一色成为。',
  tags: {
    timeTag: '9月',
    regionTag: '甲信越',
    typeTag: '花火',
  ...
  venues: [
    {
      ...
      startTime: '19:30',
      features: ['四尺玉将是尺玉多数', '大迫力的尺玉連発', '200年的伝統'],
    },
  ],
  access: [
    {
  ...
  mapEmbedUrl:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3222.8!2d138.8!3d37.3!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzfCsDE4JzAwLjAiTiAxMzjCsDQ4JzAwLjAiRQ!5e0!3m2!1sja!2sjp!4v1234567890123!5m2!1sja!2sjp',
  website: 'http://katakaimachi-enkakyokai.info/',
  related: {
