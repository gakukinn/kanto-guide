...
export const oaraiHanabiData: HanabiData = {
  ...
  description:
    '大洗海上花火大会2025〜千櫓祭〜，内閣总理大臣赏最多21回受赏的日本一花火师野村花火工业制作，约1万8000发花火照亮大洗海岸。2025-09-27开催。',
  ...
  history: {
    established: 1950,
    significance:
      '作为茨城县代表性的海上花火大会，不仅展现了传统千櫓祭文化，更体现了现代花火技术的最高水准，是连接历史与未来的重要文化活动。',
    highlights: [
  ...
  mapEmbedUrl:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3222.8!2d140.5742!3d36.3128!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x602248b8c5c5c5c5%3A0x7e4c5e5b8a2c8c8c!2z5aSn5rSX5rW35pin5YWs5ZyS!5e0!3m2!1sja!2sjp!4v1620000000000!5m2!1sja!2sjp',

  // 媒体信息
  media: [
    {
      type: 'image' as const,
      url: '/images/kitakanto/hanabi/oarai-hanabi-beach.jpg',
      title: '大洗阳光海滩花火大会',
      description: '太平洋背景下的海上花火',
    },
    {
      type: 'image' as const,
      url: '/images/kitakanto/hanabi/oarai-hanabi-fireworks.jpg',
      title: '大洗海上花火大会终章',
      description: '约1万8000发花火点亮夜空与海面的壮观终章',
    },
  ],

  // 官方数据源验证
  officialSource: {
    walkerPlusUrl: 'https://hanabi.walkerplus.com/detail/ar0308e00860/',
