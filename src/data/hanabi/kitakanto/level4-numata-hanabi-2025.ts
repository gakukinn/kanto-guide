...
export const numataHanabiDetailData: HanabiData = {
  ...
  title: '第13回沼田花火大会 - 群馬县沼田市利根川花火详情',
  description:
    '2025年9月13日在群馬县沼田市利根川河川敷举办的第13回沼田花火大会。約3000発花火照亮山间夜空，約9万人观众共同观赏的传统花火祭典。',
  ...
  tips: [
    ...
    {
      category: '注意事项',
      items: ['是必持帰', '河川敷在的是禁止', '请以沼田市公式网站信息为准'],
    },
  ],
