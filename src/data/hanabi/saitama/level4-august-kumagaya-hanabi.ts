...
export const kumagayaHanabiData: HanabiData = {
  ...
  history: {
    established: 1948,
    significance:
      '熊谷市代表性夏季祭典，拥有77年历史传统，是埼玉县北部最大规模的花火大会',
    highlights: [
      '1948年开始的77年传统',
      '埼玉县北部最大规模42万人观赏',
      '荒川河畔和绝佳立地',
  ...
  mapInfo: {
    hasMap: true,
    mapNote:
      '荒川河畔（荒川大橋下流），当日17:00-22:30大规模交通规制。车辆入场禁止',
    parking: '无停车场（车辆入场禁止）',
  },
  ...
  weatherInfo: {
    ...
    rainfall: '夏季雷雨可能',
    recommendation:
      '熊谷市日本最热地区之一，白天需要严格的中暑对策，夜间河畔相对凉爽',
    rainPolicy: '悪天候时中止',
  ...
  mapEmbedUrl:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3220.5!2d139.39!3d36.15!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x601f0a0a0a0a0a0a%3A0xa0a0a0a0a0a0a0a0!2z54aK6LC35biC!5e0!3m2!1sja!2sjp!4v1600000000000!5m2!1sja!2sjp',
