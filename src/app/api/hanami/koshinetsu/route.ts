...
const koshinetsuHanamiEvents = [
  ...
  },
  {
    ...
    prefecture: '新潟县',
    peakTime: '4月中旬～5月上旬',
    features: ['🌸 花见', '⛰️ 甲信越', '🏞️ 公园', '❄️ 雪国桜'],
  },
];

const koshinetsuHanamiData = {
  metadata: {
    region: '甲信越',
    ...
    totalCount: 10,
    prefectures: ['山梨县', '长野县', '新潟县'],
    sourceUrl: 'https://hanami.walkerplus.com/ranking/ar0400/',
    lastUpdated: new Date().toISOString(),
  },
  data: koshinetsuHanamiEvents,
};
...
export async function GET() {
  try {
    return NextResponse.json(koshinetsuHanamiData);
  } catch (error) {
    console.error('获取甲信越花见会数据时出错:', error);
