...
const saitamaHanamiData = {
  metadata: {
    ...
    totalCount: 10,
    prefecture: '埼玉县',
    sourceUrl: 'https://hanami.walkerplus.com/list/ar0311/',
...
export async function GET() {
  try {
    return NextResponse.json(saitamaHanamiData);
  } catch (error) {
    console.error('获取埼玉县花见会数据时出错:', error);
