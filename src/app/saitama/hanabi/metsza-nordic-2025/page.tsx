/**
 * 第四层页面 - metsza-nordic-2025完整详情信息，包含交通、观赏、历史等
...
import { metszaNordicHanabiData } from '@/data/hanabi/saitama/level4-july-hanabi-metsza-nordic';


export default function MetszaNordicHanabiPage() {
  return (
    <HanabiDetailTemplate data={metszaNordicHanabiData} regionKey="saitama" />
  );
}
...
export async function generateMetadata() {
  return {
    ...
    description:
      '2025年7月12日起举办的梅兹塔北欧花火。19:40开始约15分钟的北欧主题音乐同步花火表演，湖面倒影观赏体验。埼玉县饭能市唯一的北欧主题花火节。',
    keywords:
      '梅兹塔, 北欧花火, 姆明谷, 花火, 埼玉县, 饭能市, 音乐同步, 湖畔花火, 2025年',
    openGraph: {
      title: '梅兹塔北欧花火2025',
