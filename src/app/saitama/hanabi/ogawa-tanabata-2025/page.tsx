/**
 * 第四层页面 - ogawa-tanabata-2025完整详情信息，包含交通、观赏、历史等
...
import { ogawaTanabataHanabiData } from '@/data/hanabi/saitama/level4-july-hanabi-ogawa-tanabata';


export default function OgawaTanabataHanabiPage() {
  return (
    <HanabiDetailTemplate data={ogawaTanabataHanabiData} regionKey="saitama" />
  );
}
...
export async function generateMetadata() {
  return {
    ...
    description:
      '2025年7月26日举办的第77回小川町七夕祭花火大会详细信息。约200发花火、约9万人参观。埼玉县比企郡传统七夕祭与花火的完美结合，JR、东武东上线小川町站即到。',
    keywords:
      '小川町, 七夕祭, 花火大会, 埼玉县, 2025年, 7月26日, 比企郡, 尺玉, 星际烟花',
    openGraph: {
