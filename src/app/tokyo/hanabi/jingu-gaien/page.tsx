/**
 * 第四层页面 - jingu-gaien完整详情信息，包含交通、观赏、历史等
...
export const metadata: Metadata = {
  title: 'Jingu Gaien - 东京花火大会完整攻略',
  description:
    'Jingu Gaien花火大会详细指南，2025年举办。精彩花火表演，绝佳观赏地点。包含交通方式、观赏地点、祭典活动等实用信息。',
  keywords: [
    'Jingu Gaien花火',
    '东京花火',
    '花火大会',
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'zh_CN',
    url: 'https://www.kanto-travel-guide.com/tokyo/hanabi/jingu-gaien',
    siteName: '关东旅游指南',
    images: [
      {
  ...
  twitter: {
    ...
    description:
      'Jingu Gaien花火大会详细指南，2025年举办。精彩花火表演，绝佳观赏地点。包含交通方式、观赏地点、祭典活动等实用信息。...',
    images: ['/images/hanabi/jingu-gaien-fireworks.svg'],
  },
  alternates: {
    canonical: '/tokyo/hanabi/jingu-gaien',
  },
  robots: {
    index: true,
    follow: true,
