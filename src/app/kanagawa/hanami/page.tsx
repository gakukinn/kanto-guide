...
const kanagawaHanamiEvents = [
  ...
  },
  {
    ...
    haveVisited: 15,
    description:
      '鎌倉のシンボル的神社での神聖な花見体験。鎌倉市の代表的観光スポット。',
    likes: 32,
    category: '花见会',
    rank: 5,
  ...
  },
  {
    ...
    haveVisited: 20,
    description:
      '戦国時代の面影を残す城跡での花見。小田原市の歴史ロマンと桜の共演。',
    likes: 37,
    category: '花见会',
    rank: 7,
  ...
  },
  {
    ...
    wantToVisit: 5,
    haveVisited: 4,
    description: '湖畔で楽しむ自然豊かな花見。相模原市緑区の山間リゾート気分。',
    likes: 9,
    category: '花见会',
    rank: 8,
  ...
  },
  {
    ...
    haveVisited: 64,
    description:
      '横浜港を望む海浜公園での花見。横浜市中区の港町風情と桜の融合。',
    likes: 129,
    category: '花见会',
    rank: 9,
  ...
  },
  {
    ...
    haveVisited: 10,
    description:
      '広大な都立公園で憩う桜。小金井市の自然豊かな大型公園での花見。',
    likes: 28,
    category: '花见会',
    rank: 10,
...
const regionConfig = {
  ...
  displayName: '神奈川县',
  emoji: '⛩️',
  description: '湘南と鎌倉の美しい花見景点',
  navigationLinks: {
    prev: { name: '千叶县', url: '/chiba/hanami', emoji: '🌊' },
    next: { name: '北关东', url: '/kitakanto/hanami', emoji: '🏔️' },
    current: { name: '神奈川县', url: '/kanagawa' },
  },
};

export default function KanagawaHanamiPage() {
  return (
    <HanamiPageTemplate
      region={regionConfig}
      events={kanagawaHanamiEvents}
      regionKey="kanagawa"
      activityKey="hanami"
      pageTitle="神奈川县花见会活动列表"
      pageDescription="⛩️神奈川县花见会🌸 体验湘南与鎌倉最美樱花盛开，感受古都与海岸的春日浪漫。"
    />
  );
}
