...
import { minatoMiraiSmartData } from '@/data/hanabi/kanagawa/level4-august-minato-mirai-smart';

export default function MinatoMiraiSmartPage() {
  return (
    <HanabiDetailTemplate data={minatoMiraiSmartData} regionKey="kanagawa" />
  );
}
...
export async function generateMetadata() {
  return {
    ...
    keywords:
      '港未来智能节庆,神奈川花火,8月花火,横滨港未来,音乐花火,SDGs,天空交响乐',
    openGraph: {
