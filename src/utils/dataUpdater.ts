...
export class DataUpdater {
  private static sources: Record<number, ExternalDataSource> = {
    1: {
      url: 'https://www.gotokyo.org/en/story/guide/january/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    2: {
      url: 'https://www.gotokyo.org/en/story/guide/february/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    3: {
      url: 'https://www.gotokyo.org/en/story/guide/march/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    4: {
      url: 'https://www.gotokyo.org/en/story/guide/april/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    5: {
      url: 'https://www.gotokyo.org/en/story/guide/may/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    6: {
      url: 'https://www.gotokyo.org/en/story/guide/june/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    7: {
    ...
    8: {
      url: 'https://www.gotokyo.org/en/story/guide/august/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    9: {
      url: 'https://www.gotokyo.org/en/story/guide/september/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    10: {
      url: 'https://www.gotokyo.org/en/story/guide/october/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    11: {
      url: 'https://www.gotokyo.org/en/story/guide/november/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
    12: {
      url: 'https://www.gotokyo.org/en/story/guide/december/index.html',
      parser: GoTokyoParser.parseMonthData,
    },
  };
  ...
  static async fetchMonthData(
    monthId: number
  ): Promise<Partial<MonthConfig> | null> {
  ...
  static async updateMonthConfig(monthId: number): Promise<MonthConfig | null> {
    ...
    const updatedConfig: MonthConfig = {
      ...
      activities:
        externalData.activities && externalData.activities.length > 0
